...
## binarize phq1 and phq2
data$phq10_yesno1 <- ifelse(is.na(data$phq1),NA, ifelse(data$phq1>9 ,1,0))
data$phq10_yesno2 <- ifelse(is.na(data$phq2),NA, ifelse(data$phq2>9 ,1,0))
...
# Merge results IRR
results_tbl_or <- rbind(
  # imp_mod_logi('phq10_yesno3','phq10_yesno2','fapgar2',"polconf2",'polconf3',w3w3,'w2'),
  # imp_mod_logi('phq10_yesno4','phq10_yesno2','fapgar2',"polconf2",'polconf3',w3w4,'w2'),
  # imp_mod_logi('phq10_yesno6','phq10_yesno2','fapgar2',"polconf2",'polconf3',w3w6,'w2'),
  # imp_mod_logi('phq10_yesno4','phq10_yesno3','fapgar3',"polconf3",'polconf4',w4w4,'w2'),
  # imp_mod_logi('phq10_yesno6','phq10_yesno3','fapgar3',"polconf3",'polconf4',w4w6,'w2'),
  # imp_mod_logi('phq10_yesno8','phq10_yesno7','fapgar7',"polconf7",'polconf8',w8w8,'w2'),
  # imp_mod_logi('phq10_yesno9','phq10_yesno8','fapgar8',"polconf8",'polconf9',w9w9,'w2'),
  # imp_mod_logi('phq10_yesno9','phq10_yesno7','fapgar7',"polconf7",'polconf8',w8w9,'w2'),
  imp_mod_logi('phq_10yesno14','phq10_yesno7','fapgar7',"polconf7",'polconf8',w8w14,'w2'),
  imp_mod_logi('phq_10yesno14','phq10_yesno8','fapgar8',"polconf8",'polconf9',w9w14,'w2')
)

results_tbl_or_fc <- rbind(
  # imp_mod_oth_logi('phq10_yesno3','phq10_yesno2','fapgar2','polconffc3',w3w3,'w2'),
  # imp_mod_oth_logi('phq10_yesno4','phq10_yesno2','fapgar2','polconffc3',w3w4,'w2'),
  # imp_mod_oth_logi('phq10_yesno6','phq10_yesno2','fapgar2','polconffc3',w3w6,'w2'),
  # imp_mod_logi('phq10_yesno4','phq10_yesno3','fapgar3',"polconffc3",'polconffc4',w4w4,'w2'),
  # imp_mod_logi('phq10_yesno6','phq10_yesno3','fapgar3',"polconffc3",'polconffc4',w4w6,'w2'),
  # imp_mod_logi('phq10_yesno8','phq10_yesno7','fapgar7',"polconffc7",'polconffc8',w8w8,'w2'),
  # imp_mod_logi('phq10_yesno9','phq10_yesno8','fapgar8',"polconffc8",'polconffc9',w9w9,'w2'),
  # imp_mod_logi('phq10_yesno9','phq10_yesno7','fapgar7',"polconffc7",'polconffc8',w8w9,'w2'),
  imp_mod_logi('phq_10yesno14','phq10_yesno7','fapgar7',"polconffc7",'polconffc8',w8w14,'w2'),
  imp_mod_logi('phq_10yesno14','phq10_yesno8','fapgar8',"polconffc8",'polconffc9',w9w14,'w2')
)

results_tbl_or_st <- rbind(
  # imp_mod_oth_logi('phq10_yesno3','phq10_yesno2','fapgar2','polconfst3',w3w3,'w2'),
  # imp_mod_oth_logi('phq10_yesno4','phq10_yesno2','fapgar2','polconfst3',w3w4,'w2'),
  # imp_mod_oth_logi('phq10_yesno6','phq10_yesno2','fapgar2','polconfst3',w3w6,'w2'),
  # imp_mod_logi('phq10_yesno4','phq10_yesno3','fapgar3',"polconfst3",'polconfst4',w4w4,'w2'),
  # imp_mod_logi('phq10_yesno6','phq10_yesno3','fapgar3',"polconfst3",'polconfst4',w4w6,'w2'),
  # imp_mod_logi('phq10_yesno8','phq10_yesno7','fapgar7',"polconfst7",'polconfst8',w8w8,'w2'),
  # imp_mod_logi('phq10_yesno9','phq10_yesno8','fapgar8',"polconfst8",'polconfst9',w9w9,'w2'),
  # imp_mod_logi('phq10_yesno9','phq10_yesno7','fapgar7',"polconfst7",'polconfst8',w8w9,'w2'),
  imp_mod_logi('phq_10yesno14','phq10_yesno7','fapgar7',"polconfst7",'polconfst8',w8w14,'w2'),
  imp_mod_logi('phq_10yesno14','phq10_yesno8','fapgar8',"polconfst8",'polconfst9',w9w14,'w2')
)


results_tbl_or %>%
  mutate(adj_or = paste0(sprintf("%.2f",(round(OR,2)))," (",sprintf("%.2f",round(LL,2)),", ",sprintf("%.2f",round(UL,2)),")")) #%>%
  # write.csv(.,'Adjusted OR_fam_mi.csv',row.names = F)

results_tbl_or_fc %>%
  mutate(adj_or = paste0(sprintf("%.2f",(round(OR,2)))," (",sprintf("%.2f",round(LL,2)),", ",sprintf("%.2f",round(UL,2)),")")) #%>%
  # write.csv(.,'Adjusted OR_fc_mi.csv',row.names = F)

results_tbl_or_st %>%
  mutate(adj_or = paste0(sprintf("%.2f",(round(OR,2)))," (",sprintf("%.2f",round(LL,2)),", ",sprintf("%.2f",round(UL,2)),")")) #%>%
  # write.csv(.,'Adjusted OR_st_mi.csv',row.names = F)
...
cc_mod_logi <- function(outcome,priordep,priorapgar,priorvar,variable,IDs,baseline) {
  varlist <- paste0(c('sex','age','emply2','marital','edulevel','hincome'),baseline)
  data_sel <- data %>% filter(member_id %in% IDs) %>% select(varlist,priorapgar,priordep,priorvar,variable,outcome)
  
  # Fit negative binomial regression models for each variable
  fit_models <- with(data = data_sel, expr = {
   glm(as.formula(paste(outcome," ~ ",varlist[1]," +",varlist[2]," +",varlist[3]," +",varlist[4]," +",varlist[5],
...
cc_mod_oth_logi <- function(outcome,priordep,priorapgar,variable,IDs,baseline) {
  varlist <- paste0(c('sex','age','emply2','marital','edulevel','hincome'),baseline)
...
# Merge results IRR
results_cc_or <- rbind(
  # cc_mod_logi('phq10_yesno3','phq10_yesno2','fapgar2',"polconf2",'polconf3',w3w3,'w2'),
  # cc_mod_logi('phq10_yesno4','phq10_yesno2','fapgar2',"polconf2",'polconf3',w3w4,'w2'),
  # cc_mod_logi('phq10_yesno6','phq10_yesno2','fapgar2',"polconf2",'polconf3',w3w6,'w2'),
  # cc_mod_logi('phq10_yesno4','phq10_yesno3','fapgar3',"polconf3",'polconf4',w4w4,'w2'),
  # cc_mod_logi('phq10_yesno6','phq10_yesno3','fapgar3',"polconf3",'polconf4',w4w6,'w2'),
  # cc_mod_logi('phq10_yesno8','phq10_yesno7','fapgar7',"polconf7",'polconf8',w8w8,'w2'),
  # cc_mod_logi('phq10_yesno9','phq10_yesno8','fapgar8',"polconf8",'polconf9',w9w9,'w2'),
  # cc_mod_logi('phq10_yesno9','phq10_yesno7','fapgar7',"polconf7",'polconf8',w8w9,'w2'),
  cc_mod_logi('phq_10yesno14','phq10_yesno7','fapgar7',"polconf7",'polconf8',w8w14,'w2'),
  cc_mod_logi('phq_10yesno14','phq10_yesno8','fapgar8',"polconf8",'polconf9',w9w14,'w2')
)

results_cc_or_fc <- rbind(
  # cc_mod_oth_logi('phq10_yesno3','phq10_yesno2','fapgar2','polconffc3',w3w3,'w2'),
  # cc_mod_oth_logi('phq10_yesno4','phq10_yesno2','fapgar2','polconffc3',w3w4,'w2'),
  # cc_mod_oth_logi('phq10_yesno6','phq10_yesno2','fapgar2','polconffc3',w3w6,'w2'),
  # cc_mod_logi('phq10_yesno4','phq10_yesno3','fapgar3',"polconffc3",'polconffc4',w4w4,'w2'),
  # cc_mod_logi('phq10_yesno6','phq10_yesno3','fapgar3',"polconffc3",'polconffc4',w4w6,'w2'),
  # cc_mod_logi('phq10_yesno8','phq10_yesno7','fapgar7',"polconffc7",'polconffc8',w8w8,'w2'),
  # cc_mod_logi('phq10_yesno9','phq10_yesno8','fapgar8',"polconffc8",'polconffc9',w9w9,'w2'),
  # cc_mod_logi('phq10_yesno9','phq10_yesno7','fapgar7',"polconffc7",'polconffc8',w8w9,'w2'),
  cc_mod_logi('phq_10yesno14','phq10_yesno7','fapgar7',"polconffc7",'polconffc8',w8w14,'w2'),
  cc_mod_logi('phq_10yesno14','phq10_yesno8','fapgar8',"polconffc8",'polconffc9',w9w14,'w2')
)

results_cc_or_st <- rbind(
  # cc_mod_oth_logi('phq10_yesno3','phq10_yesno2','fapgar2','polconfst3',w3w3,'w2'),
  # cc_mod_oth_logi('phq10_yesno4','phq10_yesno2','fapgar2','polconfst3',w3w4,'w2'),
  # cc_mod_oth_logi('phq10_yesno6','phq10_yesno2','fapgar2','polconfst3',w3w6,'w2'),
  # cc_mod_logi('phq10_yesno4','phq10_yesno3','fapgar3',"polconfst3",'polconfst4',w4w4,'w2'),
  # cc_mod_logi('phq10_yesno6','phq10_yesno3','fapgar3',"polconfst3",'polconfst4',w4w6,'w2'),
  # cc_mod_logi('phq10_yesno8','phq10_yesno7','fapgar7',"polconfst7",'polconfst8',w8w8,'w2'),
  # cc_mod_logi('phq10_yesno9','phq10_yesno8','fapgar8',"polconfst8",'polconfst9',w9w9,'w2'),
  # cc_mod_logi('phq10_yesno9','phq10_yesno7','fapgar7',"polconfst7",'polconfst8',w8w9,'w2'),
  cc_mod_logi('phq_10yesno14','phq10_yesno7','fapgar7',"polconfst7",'polconfst8',w8w14,'w2'),
  cc_mod_logi('phq_10yesno14','phq10_yesno8','fapgar8',"polconfst8",'polconfst9',w9w14,'w2')
)

# outcome <-'phq10_yesno6'
# priordep <- 'phq10_yesno3'
# priorapgar <-'fapgar3'
# priorvar <- "polconfst3"
# variable <- 'polconfst4'
# IDs <- w4w6
...
results_cc_or %>%
  ...
  # write.csv(.,'Adjusted OR_fam_cc.csv',row.names = F)

results_cc_or_fc %>%
  mutate(adj_or = paste0(sprintf("%.2f",(round(ratio,2)))," (",sprintf("%.2f",round(LL,2)),", ",sprintf("%.2f",round(UL,2)),")")) #%>%
  # write.csv(.,'Adjusted OR_fc_cc.csv',row.names = F)

results_cc_or_st %>%
  mutate(adj_or = paste0(sprintf("%.2f",(round(ratio,2)))," (",sprintf("%.2f",round(LL,2)),", ",sprintf("%.2f",round(UL,2)),")")) #%>%
  # write.csv(.,'Adjusted OR_st_cc.csv',row.names = F)
