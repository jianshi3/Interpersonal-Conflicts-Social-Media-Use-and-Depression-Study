...
proc countreg data = data.msmfinal_imputed;
  ...
  model a2 = age1 sex edulevel1 hhincome1 emply21 marital1 phq1 a1 fapgar1 /  dist=negbin;
...
proc countreg data = data.msmfinal_imputed;
  class edulevel1 hhincome1 emply21 marital1;
  by imputation_number;
  model a2 = age1 sex edulevel1 hhincome1 emply21 marital1 fapgar1 a1 phq1 /  dist=negbin;
...
proc countreg data = data.msmfinal_imputed;
  ...
  by imputation_number;
  model a3 = age1 sex edulevel1 hhincome1 emply21 marital1 phq1 a1 fapgar1 phq2 a2 fapgar2 socgpre3 par_ocb3 /  dist=negbin;
...
proc countreg data = data.msmfinal_imputed;
  class edulevel1 hhincome1 emply21 marital1;
  by imputation_number;
  model a3 = age1 sex edulevel1 hhincome1 emply21 marital1 fapgar1 a1 phq1 a2 /  dist=negbin;
...
run;
proc genmod data = data.msmfinal_weight_trimmed;
class edulevel1 hhincome1 emply21 marital1 member_id;
model phq_wx = cuma age1 sex edulevel1 hhincome1 emply21 marital1 phq1 a1 fapgar1 /dist=negbin;
weight sw;
